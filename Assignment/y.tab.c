...
static const char *const yytname[] =
{
  ...
  "'-'", "'*'", "'/'", "'\\n'", "'('", "')'", "$accept", "program",
  "statement", "expression", "open", "close", YY_NULLPTR
};
...
{
       3,     0,     1,     5,    11,     0,     4,     0,     2,     0,
       0,     0,     0,     0,     6,     7,     8,     9,    12,    10
};
...
{
       2,    11,    12,     3,     8,     9,    10,    11,    12,     4,
       3,    18,     0,     0,     0,    13,     4,    14,    15,    16,
      17,     9,    10,    11,    12
};
...
{
       0,    12,     0,     3,     9,    13,    14,    15,     8,     4,
       5,     6,     7,    14,    14,    14,    14,    14,    10,    16
};
